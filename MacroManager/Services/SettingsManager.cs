...
{
    /// <summary>
    /// Servicio para guardar y cargar configuraciones y macros
    /// Utiliza archivos JSON para persistencia de datos
    /// </summary>
    public class SettingsManager
    {
        ...
        {
            // Determinar carpeta de datos de usuario
        ...
        public bool SaveMacro(MacroConfig macro)
        {
            ...
            {
                Console.WriteLine($"Error al guardar macro: {ex.Message}");
                return false;
            }
        }
